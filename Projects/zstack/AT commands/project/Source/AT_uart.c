...
/*****************************************************
  &F – Restore Local Device's Factory Defaults
  Response 
           Response
           OK
...
/*****************************************************
+EPENABLE – Enable/Disable Local Endpoint
...
/*****************************************************
+REPENABLE – Enable/Disable Remote Endpoint
...
/*****************************************************
  EPPRINT – Print Local Endpoints Status
  Response
...
/*****************************************************
REPPRINT:<noteID> – Print Remote Endpoints Status
  Response
...
/*****************************************************
+LONOFF:[<ON/OFF>] – Set On or Off Status for the Local Node (For Local LED )
...
/***************************************
+JPAN – Join Specific PAN Execute Command 
...
/*****************************************************************************
+NTABLE – Display Neighbour Table
...
/*****************************************************************************
+UNBIND – Delete Binding on Remote Device 
...
/*****************************************************
+CLEARBIND – Clear Local Binding Table
      AT+CLEARBIND
...
AT+READATR:<Address>,<EP>,<SendMode>,<ClusterID>,<AttrID>,…< AttrID >
          ...
          <SendMode> - A Boolean type to choose transmission mode, 
                    0 – means sending command directly; 
                    1 – means sending command to a group 
...
/******************************************************************************
+DISCOVER – Discover HA Devices On The HAN
...
/**************************************************************************
+CLUSDISC – Find All Supported Clusters On A Remote Device End Point
...
+ATTRDISC - Find Supported Attributs On A Remote Device End Point Execute Command 
      AT+ATTRDISC:<NodeID>,<EP>,<ClusterID>,<AttributeID>,<MaxNumofAttr> 
        ...
        00 – Completed discovery 01 – Uncompleted discovery
*****************************************************************************/
...
/**************************************************************************
+IDQUERY – Query If Target Device(s) In Identifying Mode 
