...
extern void AT_Cmd_PANSCANCB(uint8 ResultCount,
                                         networkDesc_t *NetworkList );
extern uint8 AT_Cmd_SCAN_signal;

//MYFUNCTION: Changes for the discovery operation
ZStatus_t ZDO_NetworkDiscoveryConfirmCB( uint8 ResultCount,
                                         networkDesc_t *NetworkList )
{
  if(AT_Cmd_SCAN_signal) AT_Cmd_PANSCANCB(ResultCount, NetworkList );
